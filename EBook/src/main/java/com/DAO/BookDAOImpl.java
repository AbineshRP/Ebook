...
public class BookDAOImpl implements BookDAO {
	...
	public boolean addBooks(BookDtls b) {
		boolean f = false;
		try {
			String sql = "insert into book_dts(bookname,author,price,bookCategory,status,photos,email)values(?,?,?,?,?,?,?)";
	...
	@Override
	public boolean deleteBookos(int id) {
		boolean f = false;
	...
	@Override
	public List<BookDtls> getAllRecentdBook() {
		List<BookDtls> list = new ArrayList<BookDtls>();
		BookDtls b = null;
		try {
			String sql = "select * from book_dts where status=? order by bookId Desc";
